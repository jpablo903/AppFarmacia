...
public class PurchasesController implements KeyListener, ActionListener, MouseListener {
    ...
    //Instaciar el modelo producto
    Products product = new Products();
    ProductsDao productDao = new ProductsDao();

    String rol = rol_user;

    public PurchasesController(Purchases purchase, PurchasesDao purchaseDao, SistemaApp views) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == views.btn_add_product_to_buy) {
            DynamicCombobox supplier_cmd = (DynamicCombobox) views.cmd_purchase_supplier.getSelectedItem();
            int supplier_id = supplier_cmd.getId();
            ...
            if (getIdSupplier == 0) {
                ...
                if (getIdSupplier != supplier_id) {
                    ...
                    String supplier_name = views.cmd_purchase_supplier.getSelectedItem().toString();
                    ...
                    if (amount > 0) {
                        ...
                        cleanFieldPurchases();
                        views.cmd_purchase_supplier.setEditable(false);
            ...
            model.removeRow(views.products_table.getSelectedRow());
            calculatePurchase();
            views.txt_purchase_product_code.requestFocus();
    ...
    private void insertPurchase() {
        double total = Double.parseDouble(views.txt_purchase_total_to_play.getText());
    ...
    public void listAllPurchases() {
        if (rol.equals("Administrador")|| rol.equals("Auxiliar")) {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                row[1] = list.get(i).getSupplier_name_products();
    ...
    //Limpiar campos
    public void cleanFieldPurchases() {
        ...
        views.txt_purchase_total_to_play.setText("");
    }
    ...
    public void calculatePurchase() {
        ...
        views.txt_purchase_total_to_play.setText("" + total);
    }
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == views.jLabelPurchases) {
            if (rol.equals("Administrador")) {
                ...
                JOptionPane.showMessageDialog(null, "No tienes los permisos de Administrador");
            }
